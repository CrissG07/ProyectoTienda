<x-app-layout>
    <div class="container mx-auto mt-12 p-8 bg-white rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-8 text-center text-blue-600">Carrito de Compras</h1>
        ...
        @else
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="border border-gray-300 p-4">
                                <form action="{{ route('comprador.cart.update', $productId) }}" method="POST" class="inline">
                                    ...
                                    <button type="submit" class="ml-2 bg-blue-500 text-white py-1 px-2 rounded-md shadow hover:bg-blue-600 transition duration-200">Actualizar</button>
                                </form>
                            </td>
            ...
            <div class="mt-6 font-semibold text-lg">
                ...
                <span class="text-blue-500 text-xl">${{ number_format($total, 0) }}</span>
            </div>
